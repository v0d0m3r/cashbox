...
// configuration step. It creates a namespace called `cashbox`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", cashbox::cmake::project_name, cashbox::cmake::project_version) };
